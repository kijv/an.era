...
export const operations = {
	createOAuthToken: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, v.object({ "access_token": v.string(), "token_type": v.literal("Bearer"), "scope": v.string(), "created_at": v.pipe(v.number(), v.integer()) }), { _type: {} as unknown as { access_token: string, token_type: "Bearer", scope: string, created_at: number } })
			},
			"400": {
				"application/json": Object.assign({}, v.object({ "error": v.optional(v.picklist(["invalid_request", "invalid_client", "invalid_grant", "unauthorized_client", "unsupported_grant_type"])), "error_description": v.optional(v.string()) }), { _type: {} as unknown as { error?: "invalid_request" | "invalid_client" | "invalid_grant" | "unauthorized_client" | "unsupported_grant_type", error_description?: string } })
			},
			"401": {
				"application/json": Object.assign({}, v.object({ "error": v.optional(v.string()), "error_description": v.optional(v.string()) }), { _type: {} as unknown as { error?: string, error_description?: string } })
			}
		}
	},
	getOpenapiSpec: {
		...
		response: {
			"200": {
				"application/yaml": Object.assign({}, v.string(), { _type: {} as unknown as string })
			},
			"404": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			}
		}
	},
	getOpenapiSpecJson: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, v.object({}), { _type: {} as unknown as {} })
			},
			"404": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			}
	...
	getPing: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.PingResponseSchema, { _type: {} as unknown as s.PingResponse })
			},
			"429": {
				"application/json": Object.assign({}, s.RateLimitErrorSchema, { _type: {} as unknown as s.RateLimitError })
			}
		}
	},
	createBlock: {
		...
		parameters: {
			body: v.object({ "value": v.string(), "channel_ids": v.pipe(v.array(v.pipe(v.number(), v.integer())), v.minLength(1), v.maxLength(6)), "title": v.optional(v.string()), "description": v.optional(v.string()), "original_source_url": v.optional(v.pipe(v.string(), v.url())), "original_source_title": v.optional(v.string()), "alt_text": v.optional(v.string()), "insert_at": v.optional(v.pipe(v.number(), v.integer())) })
		},
		response: {
			"201": {
				"application/json": Object.assign({}, s.BlockSchema, { _type: {} as unknown as s.Block })
			},
			"400": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	updateBlock: {
		...
		parameters: {
			path: v.object({ "id": v.pipe(v.number(), v.integer()) }),
			body: v.object({ "title": v.optional(v.string()), "description": v.optional(v.string()), "content": v.optional(v.string()), "alt_text": v.optional(v.string()) })
		},
		response: {
			"200": {
				"application/json": Object.assign({}, s.BlockSchema, { _type: {} as unknown as s.Block })
	...
	getBlockConnections: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.ChannelListResponseSchema, { _type: {} as unknown as s.ChannelListResponse })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getBlockComments: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.CommentListResponseSchema, { _type: {} as unknown as s.CommentListResponse })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	createChannel: {
		...
		response: {
			"201": {
				"application/json": Object.assign({}, s.ChannelSchema, { _type: {} as unknown as s.Channel })
			},
			"400": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getConnection: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.ConnectionSchema, { _type: {} as unknown as s.Connection })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getChannelContents: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.ConnectableListResponseSchema, { _type: {} as unknown as s.ConnectableListResponse })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getChannelFollowers: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.UserListResponseSchema, { _type: {} as unknown as s.UserListResponse })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getCurrentUser: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.UserSchema, { _type: {} as unknown as s.User })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getUserFollowing: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.FollowableListResponseSchema, { _type: {} as unknown as s.FollowableListResponse })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	getGroup: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.GroupSchema, { _type: {} as unknown as s.Group })
			},
			"401": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
	...
	search: {
		...
		response: {
			"200": {
				"application/json": Object.assign({}, s.EverythingListResponseSchema, { _type: {} as unknown as s.EverythingListResponse })
			},
			"400": {
				"application/json": Object.assign({}, s.ErrorSchema, { _type: {} as unknown as s.Error })
			},
