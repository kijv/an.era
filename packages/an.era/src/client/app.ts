...
type Endpoints = {
  ...
  '/v3/ping': {
    $get:
      | {
          input: {};
          output: components['schemas']['PingResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/uploads/presign': {
    $post:
      | {
          ...
          output: components['schemas']['PresignResponse'];
          outputFormat: 'json';
          status: 201;
        }
      | {
  ...
  '/v3/blocks/batch': {
    $post:
      | {
          ...
          output: components['schemas']['BatchResponse'];
          outputFormat: 'json';
          status: 202;
        }
      | {
  ...
  '/v3/blocks/batch/:batch_id': {
    $get:
      | {
          ...
          output: components['schemas']['BatchStatus'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/me/feed': {
    $get:
      | {
          input: { query: { limit?: number; next?: string; prev?: string } };
          output: components['schemas']['FeedListResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/me/notifications': {
    $get:
      | {
          ...
          output: components['schemas']['NotificationListResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/me/notifications/read': {
    $post:
      | {
          input: {};
          output: components['schemas']['NotificationsReadAllResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/me/notifications/:id/read': {
    $post:
      | {
          input: { param: { id: number } };
          output: components['schemas']['NotificationReadResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/users/:id': {
    $get:
      | {
          input: { param: { id: string } };
          output: components['schemas']['User'];
          outputFormat: 'json';
          status: 200;
        }
      | {
      ...
      | {
          input: {
            json: {
               ...
               */
              avatar_url?: string;
              /** @description Role assigned to new members joining the group. Defaults to `member`. */
  ...
  '/v3/groups/:id/members': {
    $get:
      | {
          ...
          output: components['schemas']['GroupMemberListResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
    ...
    $post:
      | {
          ...
          output: components['schemas']['GroupMember'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/groups/:id/members/:user_id': {
    $delete:
      | {
          input: { param: { id: string; user_id: number } };
          output: {};
          outputFormat: 'json';
          status: 204;
        }
    ...
    $patch:
      | {
          input: {
            param: { id: string; user_id: number };
            json: {
  ...
  '/v3/groups/:id/invitations': {
    $get:
      | {
          ...
          output: components['schemas']['MembershipInvitationListResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
    ...
    $post:
      | {
          ...
          output: components['schemas']['GroupMemberInviteResponse'];
          outputFormat: 'json';
          status: 200;
        }
      | {
  ...
  '/v3/groups/:id/invitations/:invitation_id': {
    $delete:
      | {
          input: { param: { id: string; invitation_id: number } };
          output: {};
          outputFormat: 'json';
          status: 204;
        }
  ...
  '/v3/groups/:id/invite': {
    $get:
      | {
          input: { param: { id: string } };
          output: components['schemas']['GroupInvite'];
          outputFormat: 'json';
          status: 200;
        }
      | {
