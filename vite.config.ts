...
export default defineConfig({
  ...
  lint: {
    plugins: ["unicorn", "typescript", "oxc", "react", "react-perf", "nextjs", "import"],
    categories: {
      perf: "warn",
    },
    rules: {
    ...
    globals: {},
    ignorePatterns: ["packages/an.era/src/openapi/**", "packages/an.era/src/schema.ts"],
    overrides: [
      {
        files: ["packages/an.era/src/**"],
        rules: {
          "no-console": "error",
        },
      },
