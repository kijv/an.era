...
type EmbeddedConnection = { id: number, position: number, pinned: boolean, connected_at: string, connected_by: EmbeddedUser };
...
type BlockSource = { url: string, title?: string | null, provider?: BlockProvider };
...
type Comment = { id: number, type: "Comment", body?: MarkdownContent, created_at: string, updated_at: string, user: EmbeddedUser, _links: Links };
...
type Channel = { id: number, type: "Channel", slug: string, title: string, description?: MarkdownContent, state: "available" | "deleted", visibility: ChannelVisibility, created_at: string, updated_at: string, owner: ChannelOwner, counts: ChannelCounts, _links: Links, connection?: EmbeddedConnection, can?: ChannelAbilities };
...
type BaseBlockProperties = { id: number, base_type: "Block", title?: string | null, description?: MarkdownContent, state: "processing" | "available" | "failed", visibility: "public" | "private" | "orphan", comment_count: number, created_at: string, updated_at: string, user: EmbeddedUser, source?: BlockSource, _links: Links, connection?: EmbeddedConnection, can?: BlockAbilities };
